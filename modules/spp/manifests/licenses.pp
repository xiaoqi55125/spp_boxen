...
class spp::licenses {
  ...
  file { "/Users/${::boxen_user}/Library/Application Support/Sublime Text 2/Settings/License.sublime_license":
    ensure  => link,
    mode    => '0644',
  ...
  file { "/Users/${::boxen_user}/Library/Application Support/SourceTree/sourcetree.license":
    ensure  => present,
    mode    => '0644',
